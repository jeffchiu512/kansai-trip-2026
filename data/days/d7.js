export function applyD7Plan(trip, { addJourney, schedule, setDay }) {
  addJourney(
  ...
  setDay({
    ...
    transportSummary: {
      displayText: "步行＋Osaka Metro＋南海電車；下午回新今宮領行李後順路停臨空城，再搭一站到關西機場日航酒店。"
    },
    notices: [
      {
    ...
    events: [
      {
        id: "d7-kizu-market",
        type: "visit",
        schedule: schedule("07:50", "08:50", "07:50 - 08:50"),
        title: "木津卸売市場 (木津市場早市)",
        ...
        reservationId: null,
        highlights: [{ id: "d7-kizu-market-highlight-1", text: "🍣 必吃：海鮮丼 / 握壽司 / 天丼 / 肉吸い" }],
        actions: []
      },
      {
        id: "d7-namba-yasaka",
        type: "visit",
        schedule: schedule("09:00", "09:20", "09:00 - 09:20"),
        title: "難波八阪神社",
        ...
        reservationId: null,
        highlights: [{ id: "d7-namba-yasaka-highlight-1", text: "⛩️ 免費參拜・重點拍獅子殿" }],
        actions: []
      },
      {
        id: "d7-checkout",
        type: "logistics",
        schedule: schedule("09:40", "10:00", "09:40 - 10:00"),
        title: "回住宿取行李 & 退房",
        ...
        reservationId: null,
        highlights: [{ id: "d7-checkout-highlight-1", text: "⏰ 10:00 前完成退房・行李寄放後再去心齋橋" }],
        actions: []
      },
      {
        id: "d7-pokemon-center",
        type: "shopping",
        schedule: schedule("10:30", "11:15", "10:30 - 11:15"),
        ...
        reservationId: null,
        highlights: [{ id: "d7-pokemon-center-highlight-1", text: "⚡ 同棟順遊：9F 寶可夢中心 → 10F 午餐" }],
        actions: []
      },
      {
        id: "d7-jojoen",
        type: "meal",
        schedule: schedule("11:30", "13:00", "11:30 - 13:00"),
        ...
        relatedPlaceIds: ["aozora-blue-daimaru-shinsaibashi"],
        flightId: null,
        transportBeforeId: "tr-d7-jojoen",
        reservationId: "rsv-jojoen",
        highlights: [
          { id: "d7-jojoen-highlight-1", text: "🍱 首選：¥4,700 綜合午餐" },
          { id: "d7-jojoen-highlight-2", text: "🔄 備案：同樓青空blue・烏龍麵午餐" }
        ],
        actions: []
      },
      {
        ...
        type: "shopping",
        schedule: schedule("13:00", "14:30", "13:00 - 14:30"),
        title: "心齋橋最後採買／咖啡休息",
